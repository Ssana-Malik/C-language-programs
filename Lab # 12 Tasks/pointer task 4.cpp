/*  The program starts with a variable var initialized to 5.
 A pointer pointVar is declared and assigned the address of var.
 The program prints the original value of var, the address of var, the value stored in the pointer pointVar, and the content of the address pointed to by pointVar.
 The user is prompted to enter a new value for var through the pointer pointVar.
 The program prints the updated value of var.   */
#include <iostream>
using namespace std;
int main() {
